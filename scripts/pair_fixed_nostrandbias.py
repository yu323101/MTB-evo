#python3 .py strain_list
#ERR137225_1.fastq.gz --> ERR137225
import sys
...
for strain in f1:
	...
	step2="/home/zty/bowtie2-2.2.9/bowtie2 -x /home/zty/tb_h37rv.fasta -1 "+strain+"_1.fastq -2 "+strain+"_2.fastq -U "+strain+"_s.fastq -S "+strain+".sam"+"\n"
